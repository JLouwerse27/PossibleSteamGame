                        ...
                        if (numTrees < targetTrees && genTree < 1) {
                            for (int k = i + chunkSize - 1; k >= i; k--) {
                                if (k >= dirtHeight - 3 && k < dirtHeight) {
                                    jWorldA[k * WORLD_WIDTH + l] = 3;
                                    jWorldB[k * WORLD_WIDTH + l] = 3;//tree trunk
                                }
                                else if (k < dirtHeight - 3 && k >= dirtHeight - 5) {
                                    if (rand() % 2 == 0 && k % 2 == 0) {
                                        jWorldA[k * WORLD_WIDTH + l + 1] = 3;
                                        jWorldB[k * WORLD_WIDTH + l + 1] = 3;//left branch
                                    }
                                    if (rand() % 2 == 0 && k % 2 == 0) {
                                        if (rand() % 2 == 0 && k % 2 == 0) {
                                            jWorldA[k * WORLD_WIDTH + l - 1] = 3;
                                            jWorldB[k * WORLD_WIDTH + l - 1] = 3;//right branch
                                        }
                                    }
                                    jWorldA[k * WORLD_WIDTH + l] = 3;
                                    jWorldB[k * WORLD_WIDTH + l] = 3;
                                }
